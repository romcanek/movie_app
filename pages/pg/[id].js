...
export default function Page({ movies, page }) {
...
export async function getServerSideProps({ query }) {
    ...
    const res = await fetch(`https://api.themoviedb.org/3/movie/popular?api_key=21554939a4e98e7871eb65fef98fb774&language=en-US&page=${query.id}`)
